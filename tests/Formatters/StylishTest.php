...
use function PHP\Project\Lvl2\Formatters\stylish\arrayToStr;
use function PHP\Project\Lvl2\Formatters\stylish\makeOutputArray;
...
class StylishTest extends TestCase
{
    ...
    public function testFormat(): void
    {
        ...
        $actual = formatStylish($this->diff);
